                ...
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="grid gap-4 md:gap-6">
                        {notes.map((note, index) => (
                            ...
                            >
                                <div className="card-premium p-6 flex items-center gap-6 hover:shadow-medium">
                                    {/* Icon */}
                                    <div className={`w-14 h-14 rounded-2xl flex items-center justify-center flex-shrink-0 ${note.isPremium ? 'bg-gradient-to-br from-primary/20 to-primary/5' : 'bg-muted'}`}>
                                        {note.isPremium ? (
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {note.isPremium && (
                                                <span className="inline-flex items-center gap-1 bg-primary/10 text-primary px-2 py-0.5 rounded-full text-xs font-medium flex-shrink-0">
                                                    <Crown size={12} />
                                                    Premium
                                                </span>
                                            )}
                                    ...
                                    {/* Arrow */}
                                    <div className="w-10 h-10 rounded-xl bg-muted/50 flex items-center justify-center flex-shrink-0 group-hover:bg-primary group-hover:text-primary-foreground transition-colors">
                                        <ArrowRight size={18} />
                                    </div>
                                </div>
                            </Link>
