                ...
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                        {subjects.map((subject, index) => (
                            ...
                            >
                                <div className={`bg-card rounded-2xl p-6 h-full flex flex-col transition-all duration-300 hover:shadow-medium hover:-translate-y-1 border border-border ${subject.isPremium ? "relative overflow-hidden" : ""}`}>
                                    {subject.isPremium && (
                                        <div className="absolute top-4 right-4 bg-lime rounded-full px-3 py-1 text-xs font-semibold flex items-center gap-1">
                                            <Lock size={12} />
                                            Premium
                                        </div>
                                    )}
