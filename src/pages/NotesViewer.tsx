...
import { ArrowLeft, Crown, Lock, ShieldAlert } from 'lucide-react';
...
const NotesViewer = () => {
    ...
    useEffect(() => {
        ...
        const checkReadingTime = () => {
            ...
            if (duration >= 5 && !isLocked) {
                setIsLocked(true);
                setShowSignupPopup(true);
                setCanCloseSignup(false);
                setSignupMessage('You\'ve been reading for 5 minutes. Please sign up to continue.');
                toast.info('Please sign up to continue reading');
            }
        };

        const interval = setInterval(checkReadingTime, 10000); // Check every 10 seconds
                ...
                <div className="container mx-auto px-4 lg:px-8">
                    ...
                    <div className="mb-8 animate-fade-up stagger-1">
                        ...
                        <p className="text-muted-foreground">
                            Computer Engineering • Data Structures & Algorithms
                        </p>
                    </div>
                    ...
                    <div className={`animate-fade-up stagger-2 relative ${isLocked ? 'pointer-events-none' : ''}`}>
                        ...
                        {/* Lock Overlay for 5-min timeout */}
                        {isLocked && (
