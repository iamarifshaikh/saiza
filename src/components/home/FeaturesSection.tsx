        ...
        <section className="py-24 lg:py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                    ...
                    <Reveal animation="reveal-slide-left" duration={1} delay={0.2}>
                        <div className="relative">
                            {/* Main Image Container */}
                            <div className="relative rounded-[3rem] overflow-hidden glass-card aspect-square lg:aspect-[4/3] p-4 shadow-xl border-white/40 dark:border-white/5">
                            ...
                            <div className="absolute top-12 -left-8 glass-card p-5 rounded-[2rem] animate-float shadow-xl border-white/60 dark:border-white/5 dark:bg-slate-900/40 z-30" style={{ animationDelay: '0s' }}>
                                <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest mb-2">Platform Growth</p>
                                <div className="flex items-center gap-3">
                                    <span className="text-2xl font-black text-foreground">25.20%</span>
                                    <span className="px-2 py-0.5 bg-primary/20 text-primary text-[8px] font-black rounded-full uppercase">Up</span>
                                </div>
                                <Button size="sm" className="mt-4 w-full h-10 text-[10px] font-black uppercase tracking-widest bg-foreground text-background hover:bg-primary hover:text-white transition-all rounded-full">
                                    Analytics &gt;
                                </Button>
                            </div>

                            <div className="absolute -bottom-6 right-8 glass-card p-6 rounded-[2.2rem] animate-float shadow-xl min-w-[220px] border-white/60 dark:border-white/5 dark:bg-slate-900/40 z-30" style={{ animationDelay: '1.5s' }}>
                                <div className="flex justify-between items-center mb-4">
                                    <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Progress</p>
                                    <Sparkles className="text-primary w-4 h-4" />
                                </div>
                                <h4 className="text-3xl font-black mb-3 italic tracking-tighter text-foreground">55%</h4>
                    ...
                    <div className="space-y-12">
                        ...
                        <div className="grid gap-6">
                            {features.map((feature, index) => (
                                ...
                                >
                                    <div
                                        className="group p-6 rounded-[2rem] border border-transparent hover:border-white/40 dark:hover:border-white/10 hover:glass-card transition-all duration-500 cursor-default"
                                    >
                                        <div className="flex gap-6">
                                            <div className="shrink-0 w-12 h-12 rounded-2xl bg-card border border-border group-hover:bg-primary group-hover:text-white flex items-center justify-center text-primary shadow-sm group-hover:shadow-primary/40 transition-all duration-500">
                                                <Check size={24} strokeWidth={4} />
                                            </div>
                                            <div>
                                                <h4 className="text-xl font-black mb-2 tracking-tight group-hover:text-primary transition-colors text-foreground">{feature.title}</h4>
